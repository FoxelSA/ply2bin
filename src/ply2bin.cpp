...
int main(int argc, char** argv) {
    ...
    try {
          ...
          << "[-t|--addTrans]    additional transformation (rigid transformation of openMVG point cloud)\n"
          << "[-j|--useJson]     export point cloud in json file or binary file. Default is binary\n"
          << "[-i|--pano]        complete path of the eqr panorama associated to pose file, for graphical export of projection\n"
